...
<header class="w-full bg-white border-b border-[#E4E4E4] relative z-50">
 ...
 <main class="flex-grow bg-white py-16 px-6 sm:px-[120px]">
    ...
    <!-- Scrollable Cards -->
    <div id="news-cards-container" class="no-hover-cards flex overflow-x-auto overflow-y-hidden space-x-8 pb-6 scrollbar-thin scrollbar-thumb-[#003673]/70 scrollbar-track-gray-200">
      <!-- Cards will be generated dynamically by JavaScript -->
    </div>

    <!-- Modal for Full Article -->
    <div id="article-modal" class="fixed flex inset-0 hidden z-50 items-center justify-center">
      <div class="bg-white rounded-[15px] shadow-[0_6px_20px_rgba(0,0,0,0.25)] max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center p-6 border-b border-gray-200">
          <h3 id="modal-title" class="text-[24px] font-[Oswald] font-semibold text-[#003673]"></h3>
          <button id="close-modal" class="text-gray-500 hover:text-gray-700 text-2xl">&times;</button>
        </div>
        <div id="modal-content" class="p-6 text-gray-700">
