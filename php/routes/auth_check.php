...
if (empty($_SESSION['token'])) {
    header("Location: /iSecure_CapstoneProject-main/php/routes/Pages/login-page.php?not_logged_in=1");
    exit;
}
...
if (!$session) {
    ...
    session_unset();
    session_destroy();
    header("Location: /iSecure_CapstoneProject-main/php/routes/Pages/login-page.php?expired=1");
    exit;
}

// ✅ 3. Set user_id in session for later use
$_SESSION['user_id'] = $session['user_id'];

// ✅ 4. Sanitize output for use in UI
